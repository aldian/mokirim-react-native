...
class _AskLoginScreenHeader extends React.Component {
  render() {
    ...
    return <StyleProvider style={getTheme(themeVars)}>
      <Header noShadow style={{backgroundColor: themeVars.toolbarDefaultBg}}>
        ...
        <HeaderBody>
          <HeaderTitle>{translate("headerAskLogin")}</HeaderTitle>
        </HeaderBody>
      </Header>
    </StyleProvider>
  }
...
export const AskLoginScreenHeader = connect(mapStateToProps, mapDispatchToProps)(_AskLoginScreenHeader);
