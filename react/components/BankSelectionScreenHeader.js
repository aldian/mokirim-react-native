...
class _BankSelectionScreenHeader extends React.Component {
  render() {
...
export const BankSelectionScreenHeader = connect(mapStateToProps, mapDispatchToProps)(_BankSelectionScreenHeader);
