...
class _ShipmentDetailsScreenHeader extends React.Component {
  render() {
    ...
    return <StyleProvider style={getTheme(themeVars)}>
      <Header noShadow style={{backgroundColor: themeVars.toolbarDefaultBg}}>
        ...
        <HeaderBody>
          <HeaderTitle>{translate("headerShipmentDetails")}</HeaderTitle>
        </HeaderBody>
      </Header>
    </StyleProvider>
  }
...
export const ShipmentDetailsScreenHeader = connect(mapStateToProps, mapDispatchToProps)(_ShipmentDetailsScreenHeader);
