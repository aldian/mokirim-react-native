...
class _CheckOutScreenHeader extends React.Component {
  render() {
    ...
    return <StyleProvider style={getTheme(themeVars)}>
      <Header noShadow style={{backgroundColor: themeVars.toolbarDefaultBg}}>
        ...
        <HeaderBody style={{flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start'}}>
          <HeaderTitle>{translate("headerCheckOut")}</HeaderTitle>
        </HeaderBody>
      </Header>
    </StyleProvider>
  }
...
export const CheckOutScreenHeader = connect(mapStateToProps, mapDispatchToProps)(_CheckOutScreenHeader);
