...
class _BookingCreatedScreenHeader extends React.Component {
  render() {
    ...
    return <StyleProvider style={getTheme(themeVars)}>
      <Header noShadow style={{backgroundColor: themeVars.toolbarDefaultBg}}>
        ...
        <HeaderBody>
          <HeaderTitle>{translate("headerBookingCreated")}</HeaderTitle>
        </HeaderBody>
      </Header>
    </StyleProvider>
  }
...
export const BookingCreatedScreenHeader = connect(mapStateToProps, mapDispatchToProps)(_BookingCreatedScreenHeader);
